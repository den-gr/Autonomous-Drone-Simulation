...
import it.unibo.alchemist.boundary.wormhole.impl.MapWormhole2;
 ...
 */
@Deprecated
public final class MapDisplay2<T> extends Generic2DDisplay<T, GeoPosition> {
    ...
    public void initialized(@Nonnull final Environment<T, GeoPosition> environment) {
        ...
        setWormhole(new MapWormhole2(environment, this, mapView.getModel().mapViewPosition));
        setZoomManager(new LinearZoomManager(1, 1, 2, MapWormhole2.MAX_ZOOM));
        getWormhole().center();
