...
import it.unibo.alchemist.boundary.swingui.monitor.impl.MapDisplay2;
 ...
 */
@Deprecated
public final class SingleRunGUI2 {
    ...
    public static <T, P extends Position2D<P>> void make(
        ...
        final GraphicalOutputMonitor<T, P> main =
                Objects.requireNonNull(simulation).getEnvironment() instanceof MapEnvironment
                        ? (GraphicalOutputMonitor<T, P>) new MapDisplay2<>()
        ...
        final Optional<Dimension> size = Arrays
                ...
                .min(Comparator.comparingDouble(SingleRunGUI2::area));
